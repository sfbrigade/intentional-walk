...
if (Platform.OS === 'android') {
  permissions.push({ kind: Fitness.PermissionKinds.Steps, access: Fitness.PermissionAccesses.Write });
  permissions.push({ kind: Fitness.PermissionKinds.Distances, access: Fitness.PermissionAccesses.Write });
  permissions.push({ kind: Fitness.PermissionKinds.Activity, access: Fitness.PermissionAccesses.Read });
  permissions.push({ kind: Fitness.PermissionKinds.Activity, access: Fitness.PermissionAccesses.Write });
}
...
async function requestPermissions() {
  ...
  if (Platform.OS === 'android') {
    ...
    if (result['android.permission.ACTIVITY_RECOGNITION'] !== PermissionsAndroid.RESULTS.GRANTED &&
        result['com.google.android.gms.permission.ACTIVITY_RECOGNITION'] !== PermissionsAndroid.RESULTS.GRANTED) {
      return false;
    }
  }
